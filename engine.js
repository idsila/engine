...
class MenuScene extends Scene {
  create() {
    const sprite = new NineSlicePlane(new Texture(app.getAsset("UI.png"),20, 9, 9, 9), 3,3,3,3);
    const title = new Text("Войти в игру");
    ...
    this.ui.addChild(this.createButton(sprite, 0.90, 20, 3, 100, title, icon));
  ...
  createButton(sprite, width, height, scale, y, title, icon) {
    ...
    title.fontFamily = "pdfont";
    title.fontSize = title.fontSize / scale;
    title.strokeWidth = title.strokeWidth / scale;
    title.updateMetrics();
